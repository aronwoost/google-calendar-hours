...
var rangeChangeBtns = '<a href="" id="prev" class="btn rangeside{{if disablePrevNext}} disabled{{/if}}">PREV</a> <a href="" id="reset" class="btn rangecenter{{if disableReset}} disabled{{/if}}">RESET ${to}</a> <a href="" id="next" class="btn rangeside{{if disablePrevNext}} disabled{{/if}}">NEXT</a>';
